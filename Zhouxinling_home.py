...
def page_1():
    ...
    st.text('''茜茜公主1讲述了美丽活泼的茜茜成长在巴伐利亚一个贵族家庭，父亲是一个无忧无虑的公爵，
            经常带着茜茜去山上打猎。茜茜母亲的姐姐、奥地利皇太后苏菲打算让儿子与茜茜的姐姐海伦公主订婚，
            于是邀请了她们一家人参加他的生日庆典。茜茜跟随母亲和姐姐来到奥地利，在一次偷溜出去钓鱼时邂
            逅了年轻的皇帝弗朗茨，两人一见钟情。虽然弗朗茨已经认不出自己的表妹，却深深被她的美丽开朗吸
            引着，但当茜茜听说弗朗茨将选姐姐为皇后的消息，便头也不回地跑了。在宴会上，弗朗茨才得知茜茜
            就是表妹伊丽莎白公主，他的脑子里再也装不下任何人了。舞会上，弗朗茨最终违背母亲的旨意，将一
            大束红玫瑰递到茜茜手中，并郑重宣布她为自己未来的皇后。茜茜又惊又喜，但她还没有准备好做一名
            皇后，尤其对于自己破坏了姐姐的幸福心中充满内疚,好在和茜茜姐妹情深的海伦公主不久就原谅了她，
            并祝愿妹妹能够得到幸福。同时，苏菲皇太后也对弗朗茨的选择非常不满，她不得不重新考虑要如何教
            育这位尚未成年的皇后。伴随着盛大婚礼的举行，茜茜成为了奥地利的皇后。''')
    st.write('书籍推荐')
    st.text('''海底两万里是法国作家儒勒·凡尔纳创作的长篇小说，是凡尔纳三部曲的第二部。主要讲述了1866年，
            海上发现了一只疑似为独角鲸的大怪物，阿龙纳斯教授及仆人康塞尔受邀参加追捕。在追捕过程中，他们
            与鱼叉手尼德·兰不幸落水，到了怪物的脊背上。他们发现这怪物并非是什么独角鲸，而是一艘构造奇妙
            的潜艇。潜艇是尼摩在大洋中的一座荒岛上秘密建造的，船身坚固，利用海水发电。尼摩船长邀请阿龙纳
            斯海底旅行。他们从太平洋出发，经过珊瑚岛、印度洋、红海、地中海、大西洋，看到海中许多罕见的动植
            物和奇异景象。途中还经历了搁浅、土著围攻、同鲨鱼搏斗、冰山封路、章鱼袭击等许多险情。最后，当潜
            艇到达挪威海岸时，三人不辞而别，回到了他们的家乡。''')
    st.write('音乐推荐')
    st.text('飘向北方')
...
def page_6():
    ...
    music = st.radio(
            '选择你喜欢的音乐或舞蹈：',
            ['1', '2', '3', '4', '5', '6', '7'],
            captions=['飘向北方','桃花诺','虞兮叹','奔跑的青春','象王行','李白','红楼梦']
    )
    messages = ''
    if music == '1':
        messages = '选择了飘向北方'
